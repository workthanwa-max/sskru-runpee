...
export class CurriculumController {
  constructor(
    ...
    private readonly curriculumGeneralService: CurriculumGeneralService,
    private readonly curriculumApplicationService: CurriculumApplicationService,
    private readonly curriculumApprovalActionService: CurriculumApprovalActionService,
  ...
  submitImplementation(@Param('id') activityId: string, @Request() req: any, @Body() body: any) {
    return this.curriculumApprovalActionService.submit(activityId, req.user.id, body);
  }
  ...
  submitGeneralInfo(@Param('id') activityId: string, @Request() req: any, @Body() body: any) {
    return this.curriculumGeneralService.submit(activityId, req.user.id, body);
  }
  ...
  submitBudgetInfo(@Param('id') activityId: string, @Request() req: any, @Body() body: any) {
    return this.curriculumApplicationService.submit(activityId, req.user.id, body);
  }
