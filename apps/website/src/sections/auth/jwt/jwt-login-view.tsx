...
import { ActionIcon, Box, Button, Card, Center, Divider, Group, Paper, PasswordInput, Stack, Text, TextInput, ThemeIcon, Title } from '@mantine/core';
...
export default function JwtLoginView() {
  ...
  React.useEffect(() => {
    if (user) {
      ...
      // ถ้าเลือก service มา ต้องตรวจสอบสิทธิ์
      if (serviceConfig) {
